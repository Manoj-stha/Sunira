...
const LegalAbout = () => {
  ...
  return (
    <div className='px-[10rem] py-[3rem] mb-16 flex flex-col items-center '>
        <div className='mb-26'>
            <h1 className='text-5xl font-bold '>Legal Services</h1>
        </div>
    <div className=' flex justify-center gap-16  '>
      <div className=' flex items-center w-[30rem] '>
        <img src={sidepic} className='w-[30rem] rounded-2xl border-8 border-gray-50 shadow-xl transition-transform duration-200 hover:scale-110 hover:shadow-2xl '/>
      </div>
      <div className='flex flex-col justify-center  '>
        <h1 className='text-4xl font-bold text-wrap w-[32rem] mb-5 leading-10 text-gray-800'>We Help You for
        Legal & Astrology Services</h1>
        <p className='w-[35rem] leading-7 text-gray-700'>
        ...
        <button className='bg-black text-white flex-wrap w-[8rem] h-[3rem] rounded-md hover:bg-blue-500  cursor-pointer mt-6 focus:outline-none focus:ring-2 focus:ring-blue-600 transition-transform duration-300 hover:scale-110 '><Link to={'/aboutus'}>Read more</Link></button>
      </div>
    </div>
    </div>
  )
