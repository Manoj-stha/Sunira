  ...
  return (
    <div className="bg-gray-800 text-gray-300  w-full py-10">
      ...
      <div className="w-full max-w-8xl px-5 md:px-[10rem] lg:px-[18rem] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-10 ">
        ...
        <div className="flex flex-col gap-4 text-left ">
          ...
          <ul className="space-y-2">
            <li onClick={() => handleClick('/')} className="cursor-pointer hover:underline">Home</li>
            <li onClick={() => handleClick('/aboutus')} className="cursor-pointer hover:underline">About Us</li>
            <li onClick={() => handleClick('/services')} className="cursor-pointer hover:underline">Services</li>
            <li onClick={() => handleClick('/blog')} className="cursor-pointer hover:underline">Blog</li>
            <li onClick={() => handleClick('/team')} className="cursor-pointer hover:underline">Team</li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-4 text-left ">
          ...
          <ul className="space-y-2">
            <li onClick={() => handleClick('/legal')} className="cursor-pointer hover:underline">Legal Service</li>
            <li onClick={() => handleClick('/astrology')} className="cursor-pointer hover:underline">Astrology Service</li>
            <li onClick={() => handleClick('/realestate')} className="cursor-pointer hover:underline">Real Estate Service</li>
            <li onClick={() => handleClick('/mediation')} className="cursor-pointer hover:underline">Mediation</li>
          </ul>
        </div>
      ...
      <div className="text-center w-full border-t border-gray-700 mt-8 pt-5">
        <p>&copy; {new Date().getFullYear()} Sunira Open Space. All rights reserved.</p>
      </div>
    </div>
  );
};
